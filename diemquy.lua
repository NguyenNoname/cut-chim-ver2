...
Tabs.Shop:AddButton({
	Title = "Nhảy cao",
	Description = "bay lên như một vị tinh tú",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Black Leg",
	Description = "Khởi đầu của mellee sigma",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Electro",
	Description = "ko khác mọe gì Fishman Karate",
	Callback = function()
...
Tabs.Shop:AddButton({
	...
	Description = "cho mấy thằng sea 1 dùng",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Dragon Claw",
	Description = "cho mấy thằng sea 2 dùng",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Đổi tộc",
	Description = "đổi tộc tránh xoắn trứng giái",
	Callback = function()
...
Tabs.Misc:AddButton({
	...
	Description = "Cháy như ac quỷ ff",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Tabs.Misc:AddButton({
	...
	Description = "Cơn mưa mèn mén (Fake)",
	Callback = function()
